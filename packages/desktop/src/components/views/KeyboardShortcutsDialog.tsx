...
export function KeyboardShortcutsDialog({
  ...
  const allShortcuts = useMemo<ShortcutItem[]>(() => [
    ...
    {
      name: 'New Request in Collection',
      keys: [modKey, 'T'],
      description: 'Create a new request in the active collection',
      category: 'contextual',
      view: 'postman',
    },
    {
    ...
    },
    {
      ...
      keys: [modKey, 'F'],
      description: 'Filter sidebar requests by name or path',
      category: 'contextual',
      view: 'postman',
    },
    {
      name: 'Format JSON Body',
      keys: [modKey, 'Shift', 'F'],
      description: 'Auto-format the request JSON body',
      category: 'contextual',
      view: 'postman',
    },
    {
