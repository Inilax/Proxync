...
export function LobbyView() {
  ...
  return (
    <div className="space-y-4 p-5 fade-in select-none">
      <div className="flex items-center justify-between border-b border-outline-variant/30 pb-3">
        ...
        <div className="flex items-center rounded-lg border border-outline-variant/30 bg-surface-container p-1">
          <button
            ...
            className={cn(
              "rounded-md px-3 py-1 font-mono text-xs font-bold transition-all cursor-pointer",
      ...
      <div className="flex items-center justify-between rounded-xl border border-outline-variant/30 bg-surface-container p-3.5">
        <div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-44 bg-surface-container-low border border-outline-variant/40 rounded-lg px-2.5 py-1.5 text-xs text-on-surface focus:outline-none focus:border-primary font-mono"
          />
          <button
            type="button"
            className="inline-flex items-center gap-1 rounded-lg bg-primary px-3.5 py-1.5 font-mono text-xs font-bold text-on-primary transition-all hover:bg-primary/90 shadow-sm shadow-primary/25 cursor-pointer"
          >
