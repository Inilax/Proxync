...
## [feature/proxync-native-tunnel] - 2026-08-13 (Proxync Native SSH Tunnel Engine, Zero-Trace Key Security & Custom Subdomain Support)
- **Feature Summary**:
  ...
  - **Custom & Auto-Generated Subdomain Support**: Added support for custom subdomains with auto-generated 8-character random fallback subdomains (`px-a1b2c3d4.proxync.dev`). Enabled custom subdomain configuration in `DomainSelectDialog` for Proxync Native tunnels.
- **Modified Files**:
